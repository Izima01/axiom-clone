...
const Footer = () => {
  return (
    <footer className='bg-[#060e18] px-8 mt-6 md:mt-9 lg:mt-10 pt-6 pb-6 gap-5 relative grid grid-cols-4 md:grid-cols-10'>
      <div className='absolute -top-[6.5rem] md:-top-36 lg:-top-52 left-0 w-full'>
