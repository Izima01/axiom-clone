...
const CreativeAgency = () => {
  return (
    <section className='bg-[#E4EAF1] -mt-8 md:-mt-12 px-8 grid grid-cols-5 gap-6 pt-10 md:pt-14 pb-5 items-center'>
      <div className='relative h-[29rem] col-span-5 md:col-span-2'>
        <img
          src='https://seo.axiomthemes.com/wp-content/uploads/2023/03/h3l.png'
          alt=''
          width={'70%'}
          // height={'70%'}
          className='absolute h-5/6 md:h-3/5 top-0 md:top-10 left-0'
        />
        <img
          ...
          width={'70%'}
          // height={'70%'}
          className='absolute h-5/6 md:h-3/5 right-0 bottom-0 md:bottom-10'
        />
      </div>
      ...
      <div className='col-span-5 grid grid-cols-2 md:grid-cols-4 mt-4'>
        {achievments.map(({ name, value }) => (
          <div className='relative mx-auto'>
            <h2 className='font-quicksand text-8xl md:text-9xl text-white font-extrabold tracking-widest'>
              <AnimatedCounter duration={3000} target={value} />
            </h2>
            <p className='absolute text-[#080377] text-2xl md:text-3xl font-bold font-dmsans top-1/2 left-1/2 -translate-1/2'>
              {name}
            </p>
          </div>
        ))}
